...
// Description: Main Dashboard component with Analytics Dashboard, Revenue views, and Network activities
// This component sets up the tabs and renders the content for each tab based on user selection.
...
// Defining the tabs for the dashboard
const upperTabs = ["Analytics Dashboard", "Revenue", "Network", "CLOSED"];
const lowerTabs = [
  "Candidate Pool",
...
const Dashboard = () => {
  ...
  // Rendering content for the Revenue tab
  ...
  // Rendering content for the Network tab
  ...
  // Rendering content based on the selected upper tab
  const renderDashboardContent = () => {
    switch (upperSelectedTab) {
      case 0: // Analytics Dashboard
        return (
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center mb-6">
              <ChartPieIcon className="w-8 h-8 text-blue-500 mr-3" />
      ...
      case 3: // CLOSED
        return (
          <h2 className="text-2xl font-bold">Dashboard of Closed Issues</h2>
        );
      default:
        return null;
    }
  ...
  // Main render method for the Dashboard component
  return (
